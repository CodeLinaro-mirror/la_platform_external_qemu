...
#define CONFIG_MICROBLAZE_V 1

#define CONFIG_MICROCHIP_PFSOC 1

#define CONFIG_MIPS_BOSTON_AIA 1
...
#define CONFIG_RISCV_MIPS_CMGCR 1

#define CONFIG_RISCV_MIPS_CPC 1

#define CONFIG_RISCV_MIPS_CPS 1
...
#define CONFIG_XIANGSHAN_KUNMINGHU 1
