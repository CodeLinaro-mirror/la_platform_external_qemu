...
DEF("machine", HAS_ARG, QEMU_OPTION_machine, \
    ...
    "                supported accelerators are kvm, xen, hvf, nitro, nvmm, whpx, mshv, aehd or tcg (default: tcg)\n"
...
``-machine [type=]name[,prop=value[,...]]``
    ...
    ``accel=accels1[:accels2[:...]]``
        ...
        architecture, kvm, xen, hvf, nitro, nvmm, whpx, mshv, aehd or tcg can be
...
DEF("accel", HAS_ARG, QEMU_OPTION_accel,
    ...
    "                select accelerator (kvm, xen, hvf, nitro, nvmm, whpx, mshv, aehd or tcg; use 'help' for a list)\n"
