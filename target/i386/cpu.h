...
#define CPUID_8000_0021_EAX_No_NESTED_DATA_BP         (1U << 0) /* Processor ignores nested data breakpoints */
#define CPUID_8000_0021_EAX_LFENCE_ALWAYS_SERIALIZING (1U << 2) /* LFENCE is always serializing */
#define CPUID_8000_0021_EAX_NULL_SEL_CLR_BASE         (1U << 6) /* Null Selector Clears Base */
