...
const QAndroidVirtualSceneAgent sFishtankQAndroidVirtualSceneAgent = {
        .setInitialPoster =
                [](const char* name, const char* path) {
                    NOT_IMPLEMENTED("QAndroidVirtualSceneAgent.setInitialPoster(name: %s, path: %s)", name, path);
                },
        .loadPoster =
                [](const char* name, const char* path) {
                    NOT_IMPLEMENTED("QAndroidVirtualSceneAgent.loadPoster(name: %s, path: %s)", name, path);
                    return false;
                },
        .enumeratePosters =
