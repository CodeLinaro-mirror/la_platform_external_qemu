...
typedef enum {
    ...
    kKeyCodeBrightnessDown = LINUX_KEY_BRIGHTNESSDOWN,
    kKeyCodeBrightnessUp = LINUX_KEY_BRIGHTNESSUP,
    kKeyCodeForward = LINUX_KEY_FORWARD,
    kKeyCodePreviousSong = LINUX_KEY_PREVIOUSSONG,
    kKeyCodeNextSong = LINUX_KEY_NEXTSONG,
    kKeyCodeScreenLock = LINUX_KEY_SCREENLOCK,
