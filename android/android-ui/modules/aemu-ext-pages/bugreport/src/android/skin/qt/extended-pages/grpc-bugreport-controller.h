...
// GrpcBugreportController is the implementation of the BugreportController
// that uses gRPC to interact with the emulator.
class GrpcBugreportController : public BugreportController {
public:
    GrpcBugreportController();
    // Constructor for testing purposes.
    explicit GrpcBugreportController(
            std::shared_ptr<android::emulation::control::EmulatorControlClient>
                    client);
    ~GrpcBugreportController() override = default;
