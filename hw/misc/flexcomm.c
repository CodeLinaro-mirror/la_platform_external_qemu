...
static const Property flexcomm_properties[] = {
...
static void flexcomm_class_init(ObjectClass *klass, const void *data)
{
...
static void flexcomm_function_class_init(ObjectClass *klass, const void *data)
{
